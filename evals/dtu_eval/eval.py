...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str,
                        default='/home/SENSETIME/tangziyu.vendor/projects/monosdf/code/results/DTU/scan65/dtu_grids_S3IM_mesh.ply')
    parser.add_argument('--scan', type=int, default=65)
    parser.add_argument('--mode', type=str, default='mesh', choices=['mesh', 'pcd'])
    parser.add_argument('--dataset_dir', type=str, default='/data/mydata/DTU')
    parser.add_argument('--vis_out_dir', type=str,
                        default='/home/SENSETIME/tangziyu.vendor/projects/monosdf/code/results/DTU/scan65')
